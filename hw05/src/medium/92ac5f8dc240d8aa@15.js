...
function _output1(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1200;
  const height = 1200;
...
function _output2(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1200;
  const height = 1200;
...
function _output3(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1200;
  const height = 1200;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("output1")).define("output1", ["d3","output","drag","invalidation"], _output1);
  main.variable(observer("drag")).define("drag", ["d3"], _drag);
  main.variable(observer("output2")).define("output2", ["d3","output","drag","invalidation"], _output2);
  main.variable(observer("output3")).define("output3", ["d3","output","drag","invalidation"], _output3);
  return main;
}
